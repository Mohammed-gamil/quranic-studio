...
export default function LibraryView({ chapters, loadingChapters, onSelectSurah, onOpenImport }: LibraryViewProps) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-12 md:py-20 animate-fade-in text-[var(--color-primary)]">
      {/* Header Section: Sacred Minimalism */}
      <header className="border-b-2 border-[var(--color-primary)] pb-8 mb-16 flex flex-col md:flex-row justify-between items-end gap-6 relative">
        <div className="flex flex-col gap-2">
          <span className="font-mono text-[10px] uppercase tracking-[0.3em] opacity-40">Divine Narrative Engine // v1.0.0</span>
          <h1 className="font-serif italic text-5xl leading-none tracking-tight">Library Archive</h1>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-20">
        ...
        <div className="lg:col-span-2">
          <h2 className="font-serif italic text-sm uppercase tracking-widest mb-6 opacity-60 border-b border-[var(--color-primary)]/10 pb-2">§ Featured Recitations</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div 
              ...
              className="bg-white border-2 border-[var(--color-primary)] p-6 shadow-[6px_6px_0px_0px_rgba(20,20,20,0.1)] hover:shadow-[8px_8px_0px_0px_var(--color-primary)] hover:translate-y-[-2px] transition-all cursor-pointer group flex flex-col justify-between h-48 relative overflow-hidden"
            >
              <IslamicCornerOrnament position="top-right" className="w-24 h-24 -right-4 -top-4 opacity-[0.05]" />
              <div className="flex justify-between items-start w-full relative z-10">
                <div className="p-3 border-2 border-[var(--color-primary)] bg-[var(--color-surface-dim)] group-hover:bg-[var(--color-secondary)] group-hover:text-white transition-colors">
              ...
              <div className="text-right relative z-10">
                <h3 className="text-2xl font-bold font-serif italic leading-none mb-1">سورة الرحمن</h3>
            ...
            >
              ...
              <div className="text-right relative z-10">
                <h3 className="text-2xl font-bold font-serif italic leading-none mb-1">سورة الكهف</h3>
        ...
        <div className="lg:col-span-1">
          <h2 className="font-serif italic text-sm uppercase tracking-widest mb-6 opacity-0 lg:block hidden">_</h2>
          <div 
            onClick={onOpenImport}
            className="h-48 lg:h-[calc(100%-48px)] bg-[var(--color-surface-dim)] border-2 border-dashed border-[var(--color-primary)] p-8 shadow-[6px_6px_0px_0px_rgba(20,20,20,0.05)] hover:shadow-[8px_8px_0px_0px_var(--color-primary)] hover:bg-white transition-all flex flex-col items-center justify-center cursor-pointer group relative overflow-hidden"
          >
            ...
            <div className="w-16 h-16 bg-white border-2 border-[var(--color-primary)] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform relative z-10 shadow-[4px_4px_0px_0px_var(--color-primary)]">
          ...
          {filteredSuwar.map((surah) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 text-left relative z-10">
                <div className="w-9 h-9 font-mono text-[10px] border-2 border-[var(--color-primary)] flex items-center justify-center shrink-0 bg-[var(--color-surface-dim)] font-bold">
              ...
              <span className="font-serif italic text-2xl text-[var(--color-primary)] text-right pr-1 relative z-10">
                {surah.nameAr}
              </span>
            </div>
          ))}
